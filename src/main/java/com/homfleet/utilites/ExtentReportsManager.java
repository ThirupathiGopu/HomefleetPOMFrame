...
public class ExtentReportsManager 
{
	...
	public static void startReport()
	{
		...
		spark = new ExtentSparkReporter(System.getProperty("user.dir")+"/Reports/"+dateStamp+"/"+"Homefleet"+timeStamp+".html");
		
		extent.attachReporter(spark);
		/*extent.createTest("MyFirstTest")
		  .log(Status.PASS, "This is a logging event for MyFirstTest, and it passed!");
*/	
		extent.setSystemInfo("Env_type", "Test_Env");
		extent.setSystemInfo("user_name", "Thirupathi");
		spark.config().setDocumentTitle("Homefleet html Report");
		spark.config().setReportName("Homefleet html Report");
	...
	public static void logPass(String message, String data) 
	{
